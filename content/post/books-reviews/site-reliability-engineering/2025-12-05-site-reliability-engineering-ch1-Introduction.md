...
subtitle: ""
description: "解析《Site Reliability Engineering》第一章，從傳統 Sysadmin 到 Google SRE 的思維轉變，探討錯誤預算、50% 運維上限、監控原則與應急處理，理解如何平衡系統穩定性與功能發布速度。"
date: 2025-12-05
author: "Yujie Zheng"
image: ""
...
- [📗〔讀書心得〕- SRE Ch1：Google 如何用軟體工程思維打造可靠系統](#讀書心得--sre-ch1google-如何用軟體工程思維打造可靠系統)
  - [前言](#前言)
- [傳統的系統管理方法（Sysadmin Approach）](#傳統的系統管理方法sysadmin-approach)
- [Google 的系統管理方法：SRE](#google-的系統管理方法sre)
  - [錯誤預算（Error Budget）](#錯誤預算error-budget)
  - [錯誤預算是什麼？它可以幫你「買風險」](#錯誤預算是什麼它可以幫你買風險)
- [SRE 的核心原則](#sre-的核心原則)
...
2. [What are your best tips for avoiding alert fatigue?](https://www.reddit.com/r/devops/comments/lh3wkw/what_are_your_best_tips_for_avoiding_alert_fatigue/)
